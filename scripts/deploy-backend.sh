...
env_vars="NODE_ENV=${NODE_ENV:-production},PORT=8080,GOOGLE_CLIENT_ID=${GOOGLE_CLIENT_ID},GEMINI_MODEL=${GEMINI_MODEL},GCS_UPLOAD_BUCKET=${GCS_UPLOAD_BUCKET:-},ADMIN_EMAIL=${ADMIN_EMAIL},ADMIN_NAME=${ADMIN_NAME}"
